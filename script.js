...
{
document.getElementById(winningLine[0]).style.backgroundColor = "mediumspringgreen";
document.getElementById(winningLine[1]).style.backgroundColor = "mediumspringgreen";
document.getElementById(winningLine[2]).style.backgroundColor = "mediumspringgreen";
}

function highlightLoser(winningLine)
{
...
function reset()
{
    ...
    document.getElementById("status").innerHTML = "Bereit zum Spielen?";
    document.getElementById("status").style.color = "darkgreen";
    document.getElementById("card").style.backgroundColor = "greenyellow";
